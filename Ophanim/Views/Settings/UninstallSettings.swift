...
class UninstallPreferences: NSObject, ObservableObject {
    ...
    @objc @AppStorage("RemoveChainGuardUninstall") var removeChainGuard = false
            ...
            GroupBox {
                HStack {
                    VStack(alignment: .leading) {
                        ...
                        Toggle("preferences.toggle.removeChainGuard",
                               isOn: $uninstallPreferences.removeChainGuard)
                    }
                    Spacer()
                }
            }
