...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.homepage         = 'https://ophanim.github.io/'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'AGPLv3', :file => 'LICENSE' }
    s.author           = { 'lucas lee' => 'lixin9311@gmail.com' }
    s.source           = { :git => 'https://github.com/Ophanim/Galgal.git', :tag => s.version.to_s }
    # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'
  
    s.platforms = { :ios => "14.0" }
    s.source_files = 'Galgal/**/*'
  
    # s.resource_bundles = {
    #   'GoChannel' => ['GoChannel/Assets/*.png']
    # }
    s.ios.framework  = 'UIKit', 'IOKit'
    s.exclude_files = "Galgal/Info.plist"
    s.public_header_files = 'Galgal/Galgal.h.h'
