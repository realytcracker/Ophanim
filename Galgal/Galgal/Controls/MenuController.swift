...
extension UIApplication {
    ...
    func hideCursor(_ sender: AnyObject) {
        GalgalInterface.shared!.hideCursorMove()
    }
...
var keymapping = [
    NSLocalizedString("menu.keymapping.toggleEditor", tableName: "Galgal",
                      value: "Open/Close Keymapping Editor", comment: ""),
    NSLocalizedString("menu.keymapping.deleteElement", tableName: "Galgal",
                      value: "Delete selected element", comment: ""),
    NSLocalizedString("menu.keymapping.upsizeElement", tableName: "Galgal",
                      value: "Upsize selected element", comment: ""),
    NSLocalizedString("menu.keymapping.downsizeElement", tableName: "Galgal",
                      value: "Downsize selected element", comment: ""),
    NSLocalizedString("menu.keymapping.toggleDebug", tableName: "Galgal",
                      value: "Toggle Debug Overlay", comment: ""),
    NSLocalizedString("menu.keymapping.hide.pointer", tableName: "Galgal",
                      value: "Hide Mouse Pointer", comment: ""),
    NSLocalizedString("menu.keymapping.previousKeymap", tableName: "Galgal",
                      value: "Previous Keymap", comment: ""),
    NSLocalizedString("menu.keymapping.nextKeymap", tableName: "Galgal",
...
class MenuController {
    ...
    class func keymappingMenu() -> UIMenu {
        ...
        let rotationMenu = UIMenu(
            title: NSLocalizedString("menu.keymapping.rotateDisplay", tableName: "Galgal",
        ...
        return UIMenu(title: NSLocalizedString("menu.keymapping", tableName: "Galgal",
...
extension UIMenu.Identifier {
    static var keymappingMenu: UIMenu.Identifier { UIMenu.Identifier("be.ophanim.Galgal.menus.editor") }
    static var keymappingOptionsMenu: UIMenu.Identifier { UIMenu.Identifier("be.ophanim.Galgal.menus.keymapping") }
    static var debuggingMenu: UIMenu.Identifier { UIMenu.Identifier("be.ophanim.Galgal.menus.debug") }
    static var debuggingOptionsMenu: UIMenu.Identifier { UIMenu.Identifier("be.ophanim.Galgal.menus.debugging") }
    static var rotationOptionsMenu: UIMenu.Identifier { UIMenu.Identifier("be.ophanim.Galgal.menus.rotation") }
}
