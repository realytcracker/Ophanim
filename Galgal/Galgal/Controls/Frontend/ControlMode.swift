...
public class ControlMode: Equatable {
    ...
    private func setupTextInputObservers() {
        observeTextInputEdit(begin: UITextField.textDidBeginEditingNotification,
                             end: UITextField.textDidEndEditingNotification)
        observeTextInputEdit(begin: UITextView.textDidBeginEditingNotification,
                             end: UITextView.textDidEndEditingNotification)
    }

    private func observeTextInputEdit(begin: NSNotification.Name, end: NSNotification.Name) {
